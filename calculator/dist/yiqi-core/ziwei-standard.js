...
function createZiweiChart(birthInfo) {
    try {
        ...
        const _now = new Date();
        const currentLunarYear = lunar_typescript_1.Solar.fromYmd(_now.getFullYear(), _now.getMonth() + 1, _now.getDate()).getLunar().getYear();
        const currentAge = (0, daxian_1.calculateXuSui)(lunarYear, currentLunarYear);
