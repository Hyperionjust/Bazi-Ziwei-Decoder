...
exports.resolveSolarClock = resolveSolarClock;
...
function resolveSolarClock(birthInfo) {
    ...
    if (birthInfo.isLunar) {
        const lunar = lunar_typescript_1.Lunar.fromYmd(year, month, day);
...
function createChart(birthInfo) {
    try {
        ...
        const bazi = (0, bazi_1.createBaziChart)(info);
        const ziwei = (0, ziwei_standard_1.createZiweiChart)(info);
        return {
            bazi,
            ziwei
        };
