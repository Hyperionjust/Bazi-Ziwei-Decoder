...
function createBaziChart(birthInfo) {
  try {
    ...
    console.error("\u{1F50D} \u516B\u5B57\u8BA1\u7B97\u7ED3\u679C - zhangSheng:", zhangSheng);
    console.error("\u{1F50D} \u516B\u5B57\u8BA1\u7B97\u7ED3\u679C - naYin:", naYin);
    return {
      birthInfo,
      siZhu,
      dayMaster,
...
function detectZhiRelations(zhis) {
  ...
  const explicitTypes = ["\u516D\u51B2", "\u516D\u5408", "\u516D\u5BB3", "\u4E09\u5408", "\u534A\u5408", "\u4E09\u4F1A", "\u62F1\u5408", "\u62F1\u4F1A", "\u76F8\u5211", "\u81EA\u5211", "\u76F8\u7834"];
