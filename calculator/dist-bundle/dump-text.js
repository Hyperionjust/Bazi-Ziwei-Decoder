...
function dumpBazi(b, bi) {
  ...
  if (en) {
    ...
    const zy = en.\u6B63\u7F18\u503E\u5411;
    if (zy) {
      const temperament = zy.\u76F8\u5904\u6C14\u8D28 || { \u5E74\u957F: "\u6210\u719F\u627F\u63A5\u578B", \u5E74\u8F7B: "\u7EC6\u817B\u9C9C\u6D3B\u578B", \u540C\u9F84: "\u5E73\u7B49\u540C\u9891\u578B" }[zy.\u5E74\u9F84\u503E\u5411] || "\u5173\u7CFB\u6C14\u8D28\u5F85\u5B9A";
      lines.push(`\u2502 \u251C\u6B63\u7F18\u503E\u5411(\u5173\u7CFB\u6C14\u8D28\u4F18\u5148\xB7\u5B9E\u9645\u5E74\u9F84\u4E0D\u9501\u5B9A) : \u3010${temperament}\u3011\u2014 \u4F20\u7EDF\u5E74\u9F84\u4FE1\u53F7${zy.\u5E74\u9F84\u503E\u5411}(\u4EC5\u4F5C\u8F85\u52A9,\u7F6E\u4FE1${zy.\u7F6E\u4FE1});${zy.\u592B\u59BB\u661F}:${zy.\u661F\u4F4D};\u5BAB\u5750${zy.\u5BAB\u5750} \u2014 ${zy.\u4F9D\u636E}`);
