# Bazi-Ziwei-Decoder · AI 八字紫微分析引擎

> `v4.0.0` ｜ 43 神煞 + 五派镜片 + 作用裁决 + 八字MBTI ｜ MIT ｜ 📜 [CHANGELOG](./CHANGELOG.md)

**原创设计与持续开发：[Hyperionjust](https://github.com/Hyperionjust)。** 当前的产品架构、增强与校准体系、AI 对话工作流、质量门禁、解读规范和四套海报系统，均在本仓库中独立新增或实质重构。第三方代码与历史来源按各自许可证保留署名，详见文末[致谢与许可](#-致谢与许可)及 [`NOTICE`](./NOTICE)。

这是一个装进 AI 里的「命理师技能包」。把它装进 Claude（或 Gemini、Kimi、Codex 等）之后，你只要说一句——「我是 2000 年 1 月 1 日中午 12 点出生的，男，帮我算算」——就能得到一份**排盘精确、说话有出处、不吓唬人**的八字 / 紫微解读。完全不懂命理也没关系，它会用白话引导，并优先推荐你先和 AI 聊清楚，再决定要不要把结论做成海报。
...
- [致谢与许可](#-致谢与许可) ｜ [免责声明](#️-免责声明)

---

## 它能帮你做什么

- **一份全面的人生分析**——事业、财运、婚恋、子女、健康。开头只有两段简短提醒，随后立刻给“底色、长板、提醒、阶段”四句核心结论；你说「展开第几章」它才细讲，不会先灌一大段注意事项和目录。
- **具体年份的具体问题**——「我 2027 年适合跳槽吗」「明年运势如何」，直接问，它会单独排那一年的运势精确作答，还能细到月份。
- **可以保存分享的海报长图**——一张设计好的命盘解读图（另有紫微版、八字 MBTI 版），可截图发朋友圈。八字版会先给四柱本体与八项人生坐标，近年节奏只列最多四张白话年份卡，专业运岁记录后置折叠。第一次看更推荐先聊天，确认最关心的结论后再做海报。
...
| 8 | 极简阅读提示 | 开头只用两个加粗短段说明「命盘不是判决书、选择权在你」，随后立刻进入本人解读。 |
| 9 | 速览 + 按需下钻 | 先给一页速览和章节菜单，你点哪章才细讲，不灌长文。 |
| 10 | 海报长图 | 综合 / 八字 / MBTI / 紫微四种单文件 HTML 长图；正文面向小白说人话，正向语义逐处绿色粗体。八字版总领先给四柱本体速览并突出日柱，再以八项人生坐标统领 01~08；按日主木火土金水连同大面积浅洗色一起换主题，保留宣纸、水纹与汉字水印，完整四柱详表、十神和罕见结构仍有专业说明。 |
| 11 | 八字 MBTI | 把先天格局翻成你熟悉的 MBTI 语言，措辞永远是「最像」，不是测评。 |
| 12 | 流年问答直达 | 「我 2027 年适合跳槽吗」直接问，能细到月份、能多年对比。 |
| 13 | 自带质检 | 四条海报线都有体检器把关；除字段、句数与模板外，还会拦截“正向句子仍是普通字体”的漏标。18 个回归入口一条命令跑完。 |
...
- 📋 **先聊后海报**——首回合先给四句本人速览与可展开目录，强烈推荐先和 AI 聊一轮详细分析，再决定是否制作海报；用户明确要求同轮都做时仍会照办。
...
**项目作者。** Bazi-Ziwei-Decoder 由 [Hyperionjust](https://github.com/Hyperionjust) 独立主导设计、开发与维护。项目当前的核心产品形态与主要新增／重构实现属于本仓库的原创工作。

**应保留的来源说明。** 项目早期曾以 [dzcmemory-web / bazi-ziwei-skill](https://github.com/dzcmemory-web/bazi-ziwei-skill)（MIT）为初始代码基线；现项目不是其官方延续，仍保留或构成衍生的部分继续保留原版权与许可声明。排盘内核来自 [Yiqi](https://github.com/fdxuyq/Yiqi-BaZi-ZiWei)，农历换算使用 [lunar-typescript](https://github.com/6tail/lunar-typescript)。

本项目以 MIT 发布：原创／实质重构部分 © 2026 Hyperionjust；保留部分 © 2026 dzcmemory-web。第三方组件以各自许可证为准，完整边界见 [`NOTICE`](./NOTICE) 与 [`LICENSE`](./LICENSE)。
